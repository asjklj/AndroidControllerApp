...
class WenesdayPage extends StatefulWidget {
  const WenesdayPage({super.key});

  @override
  State<WenesdayPage> createState() => _WenesdayPageState();
}

class _WenesdayPageState extends State<WenesdayPage> {
  int _count = 0;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("set Wenesday time"),
      ),
      body: Column(
        children: [
          Expanded(
